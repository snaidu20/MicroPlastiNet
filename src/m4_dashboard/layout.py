...
GLOBAL_DISCLOSURE_BANNER = html.Div(
    [
        ...
        ". No access to NOAA NCEI, Rochman SLoPP/FLOPP, Kaggle Microplastic CV, MP-Set, HydroSHEDS, or ERA5 — these sources sit behind credentialed APIs, lab-internal sharing, or institutional Copernicus/commercial licenses I don't currently have access to. "
        ...
        "Loaders pick up real files from data/raw/ once access is granted. Not for operational monitoring or regulatory submission.",
    ],
    style={
